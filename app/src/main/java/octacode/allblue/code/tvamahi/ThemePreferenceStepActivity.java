...
public class ThemePreferenceStepActivity extends Activity {
    ...
    private static final String[] OPTION_NAMES = {"Amahi Light", "Amahi Dark"};
    ...
    private static final boolean[] OPTION_CHECKED = {false, true};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (null == savedInstanceState) {
            GuidedStepFragment.add(getFragmentManager(), new ThemePreferenceStepActivity.FirstStepFragment());
        }
    }
    ...
    public static class FirstStepFragment extends GuidedStepFragment {
        ...
        public GuidanceStylist.Guidance onCreateGuidance(Bundle savedInstanceState) {
            String title = "Theme";
            String breadcrumb = "";
            String description ="Select from Light or Dark.";
        ...
        public void onCreateActions(List<GuidedAction> actions, Bundle savedInstanceState) {
            String title = "Theme";
            String desc = "Select the type of connection you want. You can set it as Amahi Light or Amahi Dark.";
